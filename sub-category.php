...
<div class="side-menu animate-dropdown outer-bottom-xs">
    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        ...
        <ul class="nav">
			...
			<?php $c=mysqli_query($con,"select categoryid from subcategory where id='$cid'");
			$r=mysqli_fetch_array($c);
			$ca=$r['categoryid'];
			?>
              <?php $sql=mysqli_query($con,"select id,subcategory  from subcategory where categoryid='$ca'");
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="imagenes/portada1.jpg" alt="" class="img-responsive">
			</div>
			<div class="container-fluid">
				<div class="caption vertical-top text-left">
					...
					<div class="excerpt hidden-sm hidden-md">
						<h1 class="section-title" style="color:white;font-size:45px;">
