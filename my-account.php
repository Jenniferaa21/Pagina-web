...
<div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['name'];?>" id="name" name="name" pattern="^[A-Za-z]+((\s)?([A-Za-z])+)*$" required="required">
					  </div>
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly pattern="^[^@]+@[^@]+\.[a-zA-Z]{2,}$ >
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Celular. <span>*</span></label>
