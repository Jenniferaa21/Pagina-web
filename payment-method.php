...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <input type="radio" name="paymethod" value="COD" checked="checked"> Efectivo
		<br>
	     <input type="radio" name="paymethod" value="Internet Banking"> Yape
		 <br>
		...
		<!-- panel-body  -->
      <h5>* El pago sera realizado al recoger los productos<h5/>
	</div><!-- row -->
</div>
<!-- checkout-step-01  -->
